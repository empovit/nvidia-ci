...
require (
	...
	github.com/openshift-kni/eco-goinfra v0.0.0-20240423175655-5fb5f561ecd9
...
require (
	...
	github.com/openshift/assisted-service v1.0.10-0.20240423165411-a03cd2cc1da5 // indirect
...
replace (
	...
	github.com/openshift/api => github.com/openshift/api v0.0.0-20240423131658-bec9f0f174e9
	github.com/openshift/assisted-service/api => github.com/openshift/assisted-service/api v0.0.0-20240222220008-d60e80f8658c
	github.com/openshift/assisted-service/models => github.com/openshift/assisted-service/models v0.0.0-20240222220008-d60e80f8658c
)
