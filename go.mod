...
require (
	...
	github.com/operator-framework/operator-lifecycle-manager v0.23.0
...
replace github.com/openshift/api => github.com/openshift/api v0.0.0-20240103200955-7ca3a4634e46
