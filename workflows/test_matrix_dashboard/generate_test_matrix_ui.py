import json
from store_data import logger, DEFAULT_MATRIX_FILE
import os
...
def test_generate_test_matrix():
    # Load the JSON data from workflows/test_matrix_dashboard/ocp_data.json
    with open(DEFAULT_MATRIX_FILE, "r") as f:
        ocp_data = json.load(f)

    # Generate the HTML content
    html_content = generate_test_matrix(ocp_data)

    # Save the HTML to workflows/test_matrix_dashboard/output (matching your GitHub Pages deploy folder)
